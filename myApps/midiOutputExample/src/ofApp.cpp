...
void ofApp::setup() {
	...
	midiOut.openPort("Launchpad S"); // by name
...
void ofApp::mousePressed(int x, int y, int button) {
  vector<unsigned char> launchpadMsg{0xB0, 0x00, 0x7F};
  midiOut.sendMidiBytes(launchpadMsg);
}

//--------------------------------------------------------------
void ofApp::mouseReleased(int x, int y, int button) {
  vector<unsigned char> launchpadMsg{0xB0, 0x00, 0x00};
  midiOut.sendMidiBytes(launchpadMsg);
}
